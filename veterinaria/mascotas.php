    ...
    <div class="container"><br>
        <div class="row justify-content-center">
            <div class="col-5 p-5 bg-white shadow-lg rounded">
                <h3>mascotas</h3>
                <hr>
                <form method="post" action="mascotasInfo.php">
                    ...
                    <div class="form-group">
                    <label for="user">Peso</label>
                        <input  class="form-control" type="text" name="peso">
                    </div>
                    <div class="form-group">
                    <label for="user">Altura</label>
                    ...
                    <div class="form-group">
                    <label for="user">id_cliente</label>
                        <input  class="form-control" type="text" name="id_cliente">
                    </div>
                    <br>
                    <button class="btn btn-primary"  name="mascotas" type="submit">Insertar</button>
                </form>
            </div>
